...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NL OS HUB · NL Arquitetos" },
      { name: "description", content: "Portal de acesso unificado ao ecossistema de sistemas internos da NL Arquitetos." },
      { name: "author", content: "NL Arquitetos" },
      { property: "og:title", content: "NL OS HUB · NL Arquitetos" },
